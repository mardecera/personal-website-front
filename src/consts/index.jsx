...
const hobbiesSubTitleESP = 'Los hobbies son esenciales para un equilibrio'
const hobbiesList = ['Photography', 'Cinema', 'Draw', 'Programming']
...
/** View: NotFound */
const notFoundMessage = 'Lo sentimos, esta pagina no se pudo encontrar.'
